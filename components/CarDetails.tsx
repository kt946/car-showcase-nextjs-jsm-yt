...
const CarDetailsImage = ({ car, angle }: { car: CarProps; angle: string }) => (
  <div className="flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg">
    <Image
      src={`https://cdn.imagin.studio/getimage?customer=${imaginApiKey}&make=${car.make}&modelFamily=${
        car.model.split(' ')[0]
                    ...
                    <div className="car-details__main-image">
                      <Image
                        src={`https://cdn.imagin.studio/getimage?customer=${imaginApiKey}&make=${
                          car.make
                        }&modelFamily=${car.model.split(' ')[0]}&zoomType=fullscreen&modelYear=${car.year}`}
                        alt="car model"
                        fill
                        priority
                        className="object-contain"
